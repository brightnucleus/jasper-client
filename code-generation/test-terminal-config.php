...
return Config::create()
    ->setWsdl('http://apitest.jasperwireless.com/ws/schema/Terminal.wsdl')
    ->setDestination(dirname(__DIR__) . '/src/SoapTypes/Terminal')
    ->setNamespace('BrightNucleus\JasperClient\SoapTypes\Terminal')
