...
return Config::create()
    ->setWsdl('http://apitest.jasperwireless.com/ws/schema/Sms.wsdl')
    ->setDestination(dirname(__DIR__) . '/src/SoapTypes/Sms')
    ->setNamespace('BrightNucleus\JasperClient\SoapTypes\Sms')
