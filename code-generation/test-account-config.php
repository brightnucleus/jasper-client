...
return Config::create()
    ->setWsdl('http://apitest.jasperwireless.com/ws/schema/Account.wsdl')
    ->setDestination(dirname(__DIR__) . '/src/SoapTypes/Account')
    ->setNamespace('BrightNucleus\JasperClient\SoapTypes\Account')
