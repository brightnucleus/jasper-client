...
return Config::create()
    ->setWsdl('http://apitest.jasperwireless.com/ws/schema/NetworkAccess.wsdl')
    ->setDestination(dirname(__DIR__) . '/src/SoapTypes/NetworkAccess')
    ->setNamespace('BrightNucleus\JasperClient\SoapTypes\NetworkAccess')
