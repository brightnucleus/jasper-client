...
return Config::create()
    ->setWsdl('http://apitest.jasperwireless.com/ws/schema/Echo.wsdl')
    ->setDestination(dirname(__DIR__) . '/src/SoapTypes/EchoClient')
    ->setNamespace('BrightNucleus\JasperClient\SoapTypes\EchoClient')
