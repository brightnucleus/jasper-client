...
return Config::create()
    ->setWsdl('http://apitest.jasperwireless.com/ws/schema/Billing.wsdl')
    ->setDestination(dirname(__DIR__) . '/src/SoapTypes/Billing')
    ->setNamespace('BrightNucleus\JasperClient\SoapTypes\Billing')
