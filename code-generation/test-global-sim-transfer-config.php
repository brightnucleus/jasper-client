...
return Config::create()
    ->setWsdl('http://apitest.jasperwireless.com/ws/schema/GlobalSimTransfer.wsdl')
    ->setDestination(dirname(__DIR__) . '/src/SoapTypes/GlobalSimTransfer')
    ->setNamespace('BrightNucleus\JasperClient\SoapTypes\GlobalSimTransfer')
