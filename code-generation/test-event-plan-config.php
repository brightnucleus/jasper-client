...
return Config::create()
    ->setWsdl('http://apitest.jasperwireless.com/ws/schema/Eventplan.wsdl')
    ->setDestination(dirname(__DIR__) . '/src/SoapTypes/EventPlan')
    ->setNamespace('BrightNucleus\JasperClient\SoapTypes\EventPlan')
