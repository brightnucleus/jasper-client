...
return Config::create()
    ->setWsdl('http://apitest.jasperwireless.com/ws/schema/Alert.wsdl')
    ->setDestination(dirname(__DIR__) . '/src/SoapTypes/Alert')
    ->setNamespace('BrightNucleus\JasperClient\SoapTypes\Alert')
